...
layers of the WBD by Hydrologic Unit (HU) digit level may also be downloaded from the following USDA NRCS ftp site:
...
before and during submittal to USDA-NRCS National Geospatial Management Center (NGMC).  
